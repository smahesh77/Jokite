...
namespace Jokite.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,JQuestion,JAns")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JQuestion,JAns")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
